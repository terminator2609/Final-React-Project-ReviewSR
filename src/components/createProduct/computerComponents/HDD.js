                    ...
                    <form action="#">
                        <div className="details-box">
                            ...
                            <div className="input-box">
                                ...
                                <input type="text" id="capacity" name="capacity" placeholder="Enter info for the capacity" required />
                            </div>
                            <div className="input-box">
                                <span className="details">Speed</span>
                                <input type="text" id="speed" name="speed" placeholder="Enter info for speed and type" required />
                            </div>
                            <div className="input-box">
                                <span className="details">Cache</span>
                                <input type="text" id="cache" name="cache" placeholder="Enter info for cache memory" required />
                            </div>
                            <div className="input-box">
